...
extern void sqrt_avx2(int N, float startGuess, float* values, float* output); // AVX2 implementation
...
int main() {
    ...
    {
        // TODO: ECE476 students.  Attempt to change the values in the
